-- ON DELETE CASCADE を ON DELETE SET NULL に戻す

-- 1. 新しいtasksテーブルを一時的な名前で作成（ON DELETE SET NULLに戻す）
CREATE TABLE tasks_new (
    ...
    FOREIGN KEY (parent_id) REFERENCES tasks_new(id) ON DELETE SET NULL
);
